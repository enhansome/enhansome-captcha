...
* [WebDecoy/FCaptcha](https://github.com/WebDecoy/FCaptcha) ⭐ 211 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-11 - Self-hosted, invisible CAPTCHA that detects bots and AI agents via behavioral analysis, TLS fingerprinting, and SHA-256 proof of work. Checkbox or invisible mode; Go, Python, and Node.js servers.
...
* [PrivateCaptcha](https://github.com/PrivateCaptcha/PrivateCaptcha) ⭐ 194 | 🐛 5 | 🌐 Go | 📅 2026-09-14 - Proof-of-Work captcha, written in Go.
...
* [dessant/buster](https://github.com/dessant/buster) ⭐ 9,296 | 🐛 50 | 🌐 JavaScript | 📅 2026-06-27 - Captcha solver extension for humans and monsters.
...
* [Tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 76,479 | 🐛 484 | 🌐 C++ | 📅 2026-09-11 - Tesseract Open Source OCR Engine.
