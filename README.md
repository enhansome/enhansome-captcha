...
* [google/recaptcha](https://github.com/google/recaptcha) ⭐ 3,578 | 🐛 6 | 🌐 PHP | 📅 2026-04-28 - PHP client library for reCAPTCHA, a free service to protect your website from spam and abuse.
...
* [WebDecoy/FCaptcha](https://github.com/WebDecoy/FCaptcha) ⭐ 213 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-15 - Self-hosted, invisible CAPTCHA that detects bots and AI agents via behavioral analysis, TLS fingerprinting, and SHA-256 proof of work. Checkbox or invisible mode; Go, Python, and Node.js servers.
...
* [PrivateCaptcha](https://github.com/PrivateCaptcha/PrivateCaptcha) ⭐ 195 | 🐛 4 | 🌐 Go | 📅 2026-09-18 - Proof-of-Work captcha, written in Go.
...
* [Tesseract](https://github.com/tesseract-ocr/tesseract) ⭐ 76,551 | 🐛 484 | 🌐 C++ | 📅 2026-09-11 - Tesseract Open Source OCR Engine.
...
Please do! Check out the [contributing.md](contributing.md) file, or [open an issue](https://github.com/ZYSzys/awesome-captcha/issues/new) ⭐ 1,424 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-10!
